...
const HeroSection: React.FC<HeroProps> = ({ setShowCart }) => {
  return (
    <section
      ...
      <div className="h-full flex items-center justify-center text-white">
        <div className="text-center max-w-4xl px-6">
          ...
          <button
            ...
            className="bg-[#32CD32] text-white px-12 py-5 rounded-md text-xl font-medium hover:bg-[#28a428] transition-colors shadow-lg"
          >
            Shop Now
          </button>
        </div>
